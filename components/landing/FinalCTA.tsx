        ...
        <Reveal delay={260}>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <button
              ...
              className="cta-glow inline-flex items-center gap-2 rounded-xl bg-accent hover:bg-accent2 active:scale-[0.98] transition-[transform,background-color] duration-150 px-6 py-3.5 font-semibold text-[15.5px] group"
            >
              Analyser mon site
